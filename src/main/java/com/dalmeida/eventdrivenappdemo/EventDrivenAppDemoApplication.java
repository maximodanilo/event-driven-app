...
public class EventDrivenAppDemoApplication {
	private static final Logger log = LoggerFactory.getLogger(EventDrivenAppDemoApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(EventDrivenAppDemoApplication.class, args);
